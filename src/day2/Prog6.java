...
public class Prog6 {
	...
	/*
	 * Write a program (called Prog6) that accepts String arguments (stored in args) from 
	 * the main method, removes all duplicates, and outputs these arguments (without duplicates) in
